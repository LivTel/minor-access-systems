 ...
 * <dl>
 * <dt><b>RCS:</b>
 * <dd>$Id: POS_DummyCommandImpl.java,v 1.1 2006/11/17 09:53:45 snf Exp $
 * <dt><b>Source:</b>
 * <dd>$Source: /home/dev/src/planetarium/java/RCS/POS_DummyCommandImpl.java,v $
 * </dl>
 * @author $Author: snf $
 * @version $Revision: 1.1 $
 */
public class POS_DummyCommandImpl implements RequestHandler {
    ...
    public POS_DummyCommandImpl(JMSMA_ProtocolServerImpl serverImpl, POS_TO_RCS command) {
	...
	if (command instanceof ABORT) {
	    ...
	    //delay = (long) Math.abs(((CCDOBSERVE)command).getExposure()) + DEF_SLEW_TIME + DEF_CONFIG_TIME;
...
// 			responseDelay = 3*(randomFile.length())/(bandwidth);
...
/** $Log: POS_DummyCommandImpl.java,v $
